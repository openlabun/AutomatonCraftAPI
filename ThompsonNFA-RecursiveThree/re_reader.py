        ...
        while self.curr_char != None:
            ...
            if self.curr_char in ALPHABET:
                ...
                while self.curr_char != None and \
                        (self.curr_char in ALPHABET or self.curr_char in '*+?'):
                    ...
                    elif self.curr_char in ALPHABET:
                        self.input.add(self.curr_char)
                ...
                if self.curr_char != None and (self.curr_char in ALPHABET or self.curr_char == '('):
                    yield Token(TokenType.APPEND, '.')
